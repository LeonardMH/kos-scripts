...
Currently, only the `compile-all-safe` option is safe to use. With the more
aggressive `compile-all` target some scripts work (those that do not declare
